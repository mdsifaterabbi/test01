    ...
    <>
      ...
      <div className="w-[100vw] my-[50px] bg-[#40b0fd] relative top-0 left-0 hidden lg:block xl:block">
        <div className="absolute bottom-[25px] left-0 xl:w-[350px] xl:h-[300px]">
          <img src="./AboutPageLogos/About_Mask_4.png" alt="About_Mask_4"></img>
        </div>
        <div className="flex lg:flex-row xl:flex-row flex-wrap gap-3 w-[90vw] mx-auto">
          ...
          <div className="lg:basis-1/6 xl:basis-1/6 py-[30px] mx-auto">
            ...
            <div className=" bg-white lg:h-[220px] xl:h-[300px] relative top-0 left-0">
              <p
                className="lg:text-[13px] lg:px-[10px] xl:text-[16px] xl:px-[20px] xl:py-[30px] text-justify"
                style={{
                  fontFamily: "Futura PT, sans-serif",
                }}
              >
            ...
            <div className="flex flex-row flex-wrap">
              <div className="basis-[47%] mx-auto">
                ...
                <div className=" bg-white h-[220px] relative top-0 left-0">
                  <p
                    className="text-[12px] sm:text-[16px] px-[10px] py-[10px] text-justify"
                    style={{
                      fontFamily: "Futura PT, sans-serif",
                    }}
                  >
