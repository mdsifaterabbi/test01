        ...
        <div className="flex flex-wrap justify-between">
          <form ref={form} onSubmit={handleSubmit(submitOrder)}>
            <input
              ...
              placeholder="Name"
              className=" bg-[#cee9ff] my-[5px] py-[5px] xl:py-[10px] pl-[5px] w-[212px] mycontactPlaceholder xl:mr-[5px]"
            />
            ...
            <input
              ...
              placeholder="Email"
              className=" bg-[#cee9ff] my-[5px] py-[5px] xl:py-[10px] pl-[5px] w-[212px]  mycontactPlaceholder"
            />
            ...
            <textarea
              ...
              placeholder="Message"
              className=" block bg-[#cee9ff] my-[5px] py-[5px] xl:py-[10px] pl-[5px] w-[430px] mycontactPlaceholder"
              style={{
                maxHeight: "250px",
                minHeight: "150px",
                marginBottom: "20px",
