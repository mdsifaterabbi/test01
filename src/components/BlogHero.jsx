import "../MyShadow.css";
import blogModuleCSS from "./BlogPageComponents/BlogBody.module.css";

const BlogHero = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row bg-[#cee9ff] pb-[100px] md:pb-[150px] md:pt-[50px] lg:pb-[50px]">
        <div className="basis-1/1 md:basis-1/2 lg:basis-1/2 lg:mt-[50px] order-1 md:order-0 px-[10px] xl:mt-[0px]">
          <h1 className="text-left font-extrabold pt-[20px] text-[20px] sm:text-[26px] md:text-xl lg:text-2xl  md:pt-[50px] md:pl-[5%] md:font-extrabold sm:pl-[5%] xl:pt-[50px] xl:font-bold xl:pl-[20%] xl:text-[38px] xl:leading-[40px]">
            Esaviour Blog's Odyssey to Self-Discovery
          </h1>
          <p
            className="text-[16px] text-justify sm:text-[16px] sm:pl-[5%] sm:pr-[5%] md:text-[14px] md:pl-[5%] mt-[20px] mb-[0px] xl:pl-[20%] xl:pr-[200px] xl:text-[18px] xl:leading-[25px] font-bold xl:font-bold"
            style={{
        ...
        <div className="basis-1/1 md:basis-1/2 lg:basis-1/2 flex justify-center order-0 md:order-1 mt-[40px] pt-[0px] lg:mt-[0px] xl:text-center xl:pt-[0px]">
          <img
            ...
            className="w-[180px] xl:w-[25%]"
          ></img>
        </div>
      </div>
      <div className="w-[90vw] xl:w-[565px] mx-auto py-[10px] rounded-md mt-[-70px] xl:mt-[-75px]">
        ...
        >
          <input
            type="text"
            placeholder="Email"
            className={`py-[5px] xl:w-[400px] pl-[5px] xl:pl-[10px] xl:mr-[65px] blogInputField ${blogModuleCSS.blogInputField}`}
          ></input>
